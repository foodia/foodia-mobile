        ...
        <div className="pl-5 flex flex-col gap-4">
          ...
          <div className="flex flex-col items-start">
            ...
            <p className="">
              ...
              Volunteer akan menjadi penanggung jawab seluruh kegiatan campaign
              dari penggalangan hingga pelaporan distribusi item kepada Penerima
              Manfaat. Donatur akan mendapatkan laporan transaksi saat Campaign
          ...
          <div className="flex flex-col items-start">
            ...
            <p>
              ...
              bersama, sehingga dapat diambil oleh seluruh Penerima Manfaat yang
              telah terverifikasi di Foodia. Kupon dapat diklaim maksimal 1x
              sehari oleh setiap Penerima Manfaat. Kupon hanya dapat discan pada
              Mitra UMKM yang telah dipilih. Donatur akan mendapatkan laporan
              transaksi saat klaim Kupon telah selesai dilakukan
            </p>
          </div>
        </div>
      ),
