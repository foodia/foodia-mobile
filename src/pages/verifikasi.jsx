    ...
    <div className="container mx-auto bg-white h-screen">
      <div className="grid justify-items-center w-full">
        ...
        <form className="justify-center pt-9 p-2 px-4 mt-5 w-full h-full">
          ...
          <div
            className={`my-1 flex flex-row items-center px-0 bg-gray-100 text-gray-400 text-sm rounded-xl w-full borde ${
              errorMessage ? " border-2 border-red-500" : "focus:border-none"
            }`}
          >
            <input
