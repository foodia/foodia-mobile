...
import { IconArrowNarrowRight, IconFileDescription } from "@tabler/icons-react";
...
const ReviewCamp = () => {
    ...
    const relation_id = router.query.id_mrch;
    ...
    const handleSubmit = () => {
        ...
        axios.post(`${process.env.NEXT_PUBLIC_API_BASE_URL}rating/create`, {
                    ...
                    <div className="py-2">
                        <div className="flex flex-row p-4 pr-4 py-0 bg-gray-100 text-gray-400 text-sm rounded-lg focus:ring-blue-500 w-full focus:border-none">
                            ...
                            <textarea
                                ...
                                value={description}
                                type="text"
                                className="ml-2 w-full min-h-[86px] p-0 py-4 pl-1 bg-transparent focus:border-none outline-none"
