        ...
        <div className="container mx-auto mt-24 bg-white h-screen ">
            <div className="grid justify-items-center w-full">
                <form className="justify-center p-2 mt-5 w-full h-full">
                    <h5 className="flex justify-center text-4xl text-primary font-bold ">Verifikasi</h5>

                    <h5 className="mt-4 flex justify-center text-center text-sm font-normal">Ketikan Kode Verifikasi Yang Telah Dikirimkan Ke Email Anda: </h5>
                    <h5 className="flex justify-center text-sm font-normal">{registrasi.email}</h5>
