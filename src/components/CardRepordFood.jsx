  ...
  return (
    <div className="flex justify-center mt-2 w-full mb-2">
      <div
        ...
        className={`bg-white hover:bg-gray-100 text-black rounded-lg inline-flex items-center shadow-lg w-80 p-1`}
      >
          ...
          <div className="flex p-1">
            ...
            <div className={`text-left ml-2`}>
              ...
              <div className="flex">
                ...
                <div
                  className={`font-sans text-xs  rounded-lg w-16 flex justify-center items-center px-2 ${
