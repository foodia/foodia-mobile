    ...
    return (
        <>
            ...
            <form className='p-2 mt-6 w-full' onSubmit={handleStepTwoSubmit}>
                                ...
                                <div className="flex items-center ml-auto">
                                    <div className="flex justify-between">
                                        <div className="flex items-center justify-center h-28">
                                            <div className="flex items-center justify-center bg-primary rounded-lg w-20 h-10">
                                                <IconCamera className="w-8 h-8 text-gray-500 dark:text-gray-400" />
                                            </div>
                                        </div>

                                        <div className="flex items-center justify-center bg-gray-50 rounded-lg w-28 h-24 ">
                                            <IconUser className="w-8 h-8 mb-2 text-gray-500 dark:text-gray-400" />
                                        </div>
                                    </div>
                                </div>
                ...
                <div className="grid gap-4 content-center px-4 h-14">
