...
function StepOne({ registrasiMerchant, setRegistrasiMerchant }) {
    ...
    const [merchant_name, setmerchant_name] = useState(registrasiMerchant?.merchant_name ?? '');
    const [ktp_number, setktp_number] = useState(registrasiMerchant?.ktp_number ?? '');
    const [self_photo, setself_photo] = useState(registrasiMerchant?.self_photo || null);
    const [ktp_photo, setktp_photo] = useState(registrasiMerchant?.ktp_photo || null);
    const [no_link_aja, setno_link_aja] = useState(registrasiMerchant?.no_link_aja ?? '');
    ...
    return (
        <>
            ...
            <form className='p-2 mt-10 w-full' onSubmit={handleSubmit}>
                <div className="mb-2">
                    <label htmlFor='merchant_name' className="text-sm font-medium text-gray-900">Merchant Name</label>
                    <InputForm
                        ...
                        label="merchant_name" type="text" name="merchant_name" value={merchant_name} onChange={handlemerchant_nameChange} placeholder="Merchant Name"
                    />
                </div>
                <div className="mb-2">
                    <label htmlFor='ktp_number' className="text-sm font-medium text-gray-900">Nomer KTP</label>
                    <InputForm
                        cssInput={`bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5`}
                        label="ktp_number" type="number" name="ktp_number" value={ktp_number} onChange={handlektp_numberChange} placeholder="Nomer KTP"
                    />
                </div>
                <div className="mb-2">
                    <label htmlFor='no_link_aja' className="text-sm font-medium text-gray-900">Link Aja</label>
                    <InputForm
                        cssInput={`bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5`}
                        label="no_link_aja" type="number" name="no_link_aja" value={no_link_aja} onChange={handleNo_link_ajaChange} placeholder="Link Aja"
                    />
                </div>

                <div className="mb-2">
                    <label htmlFor="self_photo" className="text-sm font-medium text-gray-900">Foto Selfi</label>
                ...
                <div className="mb-2">
                    <label htmlFor="ktp_photo" className="text-sm font-medium text-gray-900">Foto KTP</label>
                    <div className="flex items-center justify-center w-full">
                        <label
                            htmlFor="ktp_photo"
                            className="flex flex-col items-center justify-center w-full h-36 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-200 dark:hover:bg-gray-800 hover:bg-gray-100"
...
function StepTwo({ registrasiMerchant, setRegistrasiMerchant }) {
    ...
    const [sub_district, setSubDistrict] = useState(registrasiMerchant?.subDistrict ?? '');
    ...
    const handleSubmit = async (e) => {
        ...
        if (!address || !province || !city || !sub_district || !postal_code || !coordinates) {
            window.alert('All fields are required');
            return;
        }
    ...
    return (
        <>
            ...
            <form className="p-2 w-full" onSubmit={handleSubmit}>
                ...
                <div className="mb-2">
                    <label htmlFor='address' className="text-sm font-medium text-gray-900">Alamat</label>
                    <textarea
                ...
                <div className="mb-2">
                    <label htmlFor='province' className="text-sm font-medium text-gray-900">Provinsi</label>
                    <InputForm
                ...
                <div className="mb-2">
                    <label htmlFor='city' className="text-sm font-medium text-gray-900">Kota</label>
                    <InputForm
                        cssInput={`bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 m-1`}
                        label="city"
                        type="text"
                ...
                <div className="mb-2">
                    <label htmlFor='sub_district' className="text-sm font-medium text-gray-900">Kecamatan</label>
                    <InputForm
                        cssInput={`bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 m-1`}
                        label="sub_district"
                        type="text"
                ...
                <div className="mb-2">
                    <label htmlFor='postal_code' className="text-sm font-medium text-gray-900">Kode Pos</label>
                    <InputForm
                        cssInput={`bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 m-1`}
                        label="postal_code"
                        type="number"
