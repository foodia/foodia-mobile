...
function StepThree({ cart, updateCart, stepForm = 0 }) {
    ...
    const handleSubmit = async () => {
        try {
            ...
            const response = await axios.post('http://your-api-endpoint.com/submit-event', formData, {
                headers: {
                    ...
                    <div className="w-full bg-white  text-black rounded-lg inline-flex items-center px-4 py-2.5 ">
                        <div className="flex justify-between w-full">
                            ...
                            <div className="grid place-items-center">
                                <Link href={"/tes"} className="flex rounded-lg w-20 h-10 grid grid-cols-3 gap-4 content-center text-white bg-primary p-2 hover:shadow-lg"><IconCirclePlus />add </Link>
                            ...
                            Object.keys(groupedCart).map((storeName, storeIndex) => (
                                <div key={storeIndex} className="mb-4">
                                    ...
                                    {groupedCart[storeName].map((item, itemIndex) => (
                                        <div key={itemIndex} className="w-full bg-white text-black rounded-lg inline-flex items-center px-4 py-2.5 mb-2">
                                            <div className="flex justify-between w-full">
                                                <div className="flex">
