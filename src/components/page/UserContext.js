...
export const AppStateProvider = ({ children }) => {
    ...
    const setReportMechant = (reportMechant) => { // Perbaiki penulisan setreportMechant menjadi setReportMechant
    ...
    return (
        ...
        <AppStateContext.Provider value={{ state, setRegistrasi, setLogin, setReportMechant, setDonation }}>
            {children}
