                ...
                <div className="w-full bg-white  text-black rounded-lg inline-flex items-center px-4 py-2.5 ">
                    <div className="flex justify-between w-full">
                        ...
                        <div className="grid place-items-center">
                            <Link href="/creatcampaign?step=3" className="flex rounded-lg w-20 h-10 grid grid-cols-3 gap-4 content-center text-white bg-primary p-2 hover:shadow-lg"><IconGardenCart />Cart </Link>
                        </div>
                    </div>
                </div>
            </div>
