...
const DetailCamp = ({ data }) => {
        ...
        Swal.fire({
            ...
            html: `
              ...
              <div class="mt-4">
                ...
                <label>
                <input type="radio" name="donation" id="donation_50000" class="hidden peer" value="50000"  ${data.donation_collected > data.donation_target ? 'disabled' : ''}/>
                <div class=" ${data.donation_target > 50000 || data.donation_collected > data.donation_target ? 'cursor-not-allowed bg-gray-300' : 'cursor-pointer peer-checked:bg-blue-900 peer-checked:text-white bg-gray-100'}   py-2 px-4 rounded-lg font-semibold">Rp 50.000</div>
            </label>
            <label>
                <input  type="radio" name="donation" id="donation_100000" class="hidden peer" value="100000"  ${data.donation_target > 100000 || data.donation_collected > data.donation_target + 100000 ? 'disabled' : ''}/>
                <div class=" ${data.donation_target > 100000 || data.donation_collected > data.donation_target + 100000 ? 'cursor-not-allowed bg-gray-300' : 'cursor-pointer peer-checked:bg-blue-900 peer-checked:text-white bg-gray-100'}   py-2 px-4 rounded-lg font-semibold">Rp 100.000</div>
            </label>
            <label>
                <input  type="radio" name="donation" id="donation_250000" class="hidden peer" value="250000"  ${data.donation_target > 250000 || data.donation_collected > data.donation_target + 250000 ? 'disabled' : ''}/>
                <div class=" ${data.donation_target > 250000 || data.donation_collected > data.donation_target + 250000 ? 'cursor-not-allowed bg-gray-300' : 'cursor-pointer peer-checked:bg-blue-900 peer-checked:text-white bg-gray-100'}   py-2 px-4 rounded-lg font-semibold">Rp 250.000</div>
            </label>
            <label>
                <input  type="radio" name="donation" id="donation_500000" class="hidden peer" value="500000"  ${data.donation_target > 500000 || data.donation_collected > data.donation_target + 500000 ? 'disabled' : ''}/>
                <div class=" ${data.donation_target > 500000 || data.donation_collected > data.donation_target + 500000 ? 'cursor-not-allowed bg-gray-300' : 'cursor-pointer peer-checked:bg-blue-900 peer-checked:text-white bg-gray-100'}   py-2 px-4 rounded-lg font-semibold">Rp 500.000</div>
            </label>
                    ...
                    <div class="bg-gray-100 p-3 rounded-lg">
                      ...
                      <p class="text-xs text-gray-500">Maksimum donasi ${data.donation_target - data.donation_collected}</p>
                    </div>
                </div>
              </div>
              `,
    ...
    const handleSubmit = (value) => {
        setNominalDonasi(parseInt(value));
        if (data.donation_target < data.donation_collected + value) {
            Swal.fire({
                icon: "error",
                title: "Oops...",
                    ...
                    <div>
                        ...
                        <div className="flex justify-between">
                            <p className="font-sans text-sm">
                                ...
                                <span className="font-sans text-sm font-medium text-blue-800 ml-1">
                                    {formatUang(
                                        data.donation_collected > data.donation_target ? data.donation_target : (data.donation_collected ? data.donation_collected : 0)
                                    )}
                                </span>
                            </p>
                        </div>
